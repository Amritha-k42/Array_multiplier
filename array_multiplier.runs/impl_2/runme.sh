...
HD_PWD='C:/Users/Amritha K Poojari/OneDrive/Desktop/MAJOR project/array_multiplier/array_multiplier.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log array16.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source array16.tcl -notrace
