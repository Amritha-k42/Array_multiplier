...
HD_PWD='C:/Users/Amritha K Poojari/OneDrive/Desktop/MAJOR project/array_multiplier/array_multiplier.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log array16.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source array16.tcl
